...
def my_step(action, state, steps_beyond_terminated):
    ...
    if not terminated:
        reward = 1.0
    elif steps_beyond_terminated is None:
        # Pole just fell!
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        observation, reward, terminated, truncated, steps_beyond_terminated = my_step(action.item(), state.cpu().numpy().squeeze(), steps_beyond_terminated)
